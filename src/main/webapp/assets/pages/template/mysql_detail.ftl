...
<div class="row">
    <div class="col-sm-12" style="text-align: left;vertical-align: bottom">
        ...
        <div style="float: left;width: 600px">
            <h3>dim_user_group
            <small><span class="label label-success">mysql</span></small>
            </h3>
        </div>
    ...
    <nav style="padding: 10px;margin-bottom: 18px">
        ...
        <div class="tab-content" style="padding: 10px;">
            ...
            <div role="tabpanel" class="tab-pane" id="children">3</div>
            <div role="tabpanel" class="tab-pane" id="example">4</div>
        </div>
    </nav>
